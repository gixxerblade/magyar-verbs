        ...
        <div className="section-intro">
          ...
          >
            ...
            <ul style={{marginLeft: '1.5rem', lineHeight: '1.8'}}>
              ...
              <li>
                <strong>2nd person</strong> = the person(s) being spoken to (you)
              </li>
              <li>
                <strong>3rd person</strong> = the person(s) or thing(s) being spoken about (he, she,
                it, they)
              </li>
              <li>
                <strong>Singular</strong> = one person/thing
              </li>
              <li>
                <strong>Plural</strong> = multiple people/things
              </li>
            </ul>
          </div>
        </div>
        ...
        <div style={{display: 'grid', gap: '1rem'}}>
          <div>
            ...
            <ul className="tips" style={{marginTop: '0.5rem'}}>
              ...
              <li>
                <strong>te</strong> (you) - always ends in <code>-sz</code>
              </li>
              <li>
                <strong>ő</strong> (he/she/it) - no ending, just the verb stem
              </li>
              <li>
                <strong>mi</strong> (we) - always ends in <code>-unk/-ünk</code>
              </li>
              <li>
                <strong>ti</strong> (you all) - always ends in <code>-tok/-tek/-tök</code>
              </li>
              <li>
                <strong>ők</strong> (they) - always ends in <code>-nak/-nek</code>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="tips" style={{marginTop: '0.5rem'}}>
              ...
              <li>
                <strong>Front unrounded</strong> (e, é, i, í) → Use the "Front" column
              </li>
              <li>
                <strong>Front rounded</strong> (ö, ő, ü, ű) → Use the "Front (rounded)" column
              </li>
            </ul>
            <p
              style={{
          ...
          <div>
            ...
            <ul className="tips" style={{marginTop: '0.5rem'}}>
              ...
              <li>
                <strong>te</strong> (you) always ends in <code>-sz</code> regardless of vowel
                harmony
              </li>
              <li>
                When listening, <strong>én</strong> (I) and <strong>ő</strong> (he/she/it) can sound
                similar - pay attention to context
              </li>
            </ul>
          </div>
        </div>
